...
const experience = [
  { date: 'May 2026 — Jun 2026', role: 'Product Intern', org: 'Homerun, Bengaluru', points: [
    'Analyzed customer behavior through funnel analysis and cohort studies, identifying conversion patterns, user journey bottlenecks, and data-quality issues.',
    'Performed root cause analysis on cross-platform reporting discrepancies by validating event tracking and identifying missing or incorrect event properties.',
    'Automated reporting workflows and analytical dashboards to improve the reliability and scalability of stakeholder reporting.',
    'Worked with developers to investigate and resolve data-tracking discrepancies across platforms.',
    'Applied customer segmentation and data validation techniques to support product and business decision-making.',
  ] },
  { date: 'Jun 2025 — Sep 2025', role: 'Web Developer Intern', org: 'Valsco Technology Private Ltd, Vellore', points: [
    'Built and integrated REST API integrations for Jurident, enabling reliable communication between frontend and backend services.',
    'Developed 5+ frontend features using React.js for an AI-based legal document drafting platform.',
    'Contributed to an AI-powered legal document drafting workflow, focusing on usability and frontend integration.',
    'Designed and improved UI components for the platform\'s internal chatbot to create a smoother user experience.',
    'Tested and debugged API integrations and frontend functionality to ensure reliable feature delivery.',
    'Collaborated with the development team to integrate and refine features across the platform.',
  ] },
];
...
function App() {
  ...
  return <>
    ...
    <main id="top">
      ...
      <section id="involvement" className="reveal"><div className="wrap"><SectionHeading label="Involvement" title="Clubs & chapters" /><Timeline items={[{ date: 'Apr 2024 — Mar 2025 · 1 yr', role: 'Core Member', org: 'roboVITics — The Official Robotics Club of VIT · Vellore, Tamil Nadu', points: ["Contributed to the club's web presence and internal tools, collaborating with the core team to build and improve digital platforms.", <>Authored and published <a className="inline-link" href="https://medium.com/@roboviticsvitvellore/connecting-the-dots-apis-for-smart-robotics-integration-a494c253dbb3" target="_blank" rel="noreferrer">Connecting the Dots: APIs for Smart Robotics Integration <Arrow /></a> for the club's technical publication.</>, 'Collaborated with fellow members on technical initiatives, club activities, and knowledge-sharing sessions.', 'Helped organize and coordinate technical events and activities during the college tech fest, contributing to events with 100+ participants.', 'Gained hands-on experience in team collaboration, technical communication, event coordination, and problem-solving.'] }]} /></div></section>
